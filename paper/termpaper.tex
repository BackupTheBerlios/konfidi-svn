...
Ratings system for reputation within certain domains (eBay auctions, for example), may be of some limited use.  However, unless some system of rater verification is in place, they may be susceptible to manipulative ratings.  Even if such systems can be guarded against such attacks, why should someone base whether they trust another person on opinions given by others that they neither know nor trust?
