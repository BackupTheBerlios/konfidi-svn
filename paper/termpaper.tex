...
In this paper, we describe some difficulties in integrating reputation-based trust networks with the PGP web-of-trust, and how it might be possible to overcome them.  We then describe our structure for representing trust data, and our methods for making trust inferences on this data.  Finally, we discuss the our proof-of-concept software for putting this trust to use.

\section{Related Work}
%There are a number of technologies designed to serve various purposes.  When they are combined:  KONFIDI.  Talk a little about this here, andy
...
\section{Konfidi}
% say what konfidi does, and explain diagram
